...
- (BOOL)dayPlannerView:(MGCDayPlannerView*)view canCreateNewEventOfType:(MGCEventType)type atDate:(NSDate*)date
{
    ...
    //if app can create event at this day, return 1. Otherwise, return 0.
    //if choosed date is nearlier than current time, return 0.
    if ([date isEqual:[date laterDate:[NSDate dateWithTimeIntervalSinceNow:0]]]){
